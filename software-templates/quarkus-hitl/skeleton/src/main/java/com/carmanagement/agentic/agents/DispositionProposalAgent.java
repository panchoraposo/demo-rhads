...
/**
 * Drafts a disposition proposal that a human must review for high-value cars.
 */
public interface DispositionProposalAgent {
    ...
    @SystemMessage("""
        ...
        Decision Criteria:
        - FIRST: wrecked, totaled, destroyed, compromised frame, engine in pieces, or airbags deployed in a serious collision → SCRAP. Do not SELL a structurally unsafe car even if residual market value is high.
